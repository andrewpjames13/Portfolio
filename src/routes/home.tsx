...
export const Home = () => (
  <AnimatedPageWrapper>
    ...
    <AnimateInView stayMounted>
      <Container py={6} px={6} minH="100vh">
        <SimpleGrid columns={[1, null, 2]} spacing={[4, null, 0]}>
          {projects.map((item, i) => (
    ...
    <Container pt={6} px={6} pb={[3, null, 0]}>
      <Text
        fontSize={["4xl", "4xl"]}
        fontWeight="900"
        letterSpacing="-0.8px"
    ...
    <Container pb={6} px={6}>
      <SimpleGrid columns={[1, null, 2]} spacing={[4, null, 0]} w="full">
